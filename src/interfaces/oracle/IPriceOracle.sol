...
interface IPriceOracle {
    ...
    event OracleSet(address token, address api3Proxy);
    ...
    error PriceOracle__Api3ReaderProxyExists();
    ...
    function initialize(address _admin, address _upgrader, address _operator, address _pyth) external;
