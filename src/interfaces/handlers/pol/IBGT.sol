...
interface IBGT is IERC20, IERC20Metadata {
    /**
     ...
     */
    function boostedQueue(address account, address validator)
        external
        view
    ...
    /// @notice Returns the address of the bgt staker contract for the given account.
